...
export default function ContactPage() {
  ...
  return (
    <div className="pb-8">
      <div className="flex flex-col lg:flex-row gap-12 items-center bg-[url('https://www.transparenttextures.com/patterns/notebook.png')] p-6 sm:p-10 rounded-xl border-4 border-black shadow-brutal bg-white/40 mix-blend-multiply">
